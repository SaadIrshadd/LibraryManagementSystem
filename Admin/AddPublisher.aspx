<%@ Page Title="Add Publisher" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="AddPublisher.aspx.cs" Inherits="LibraryManagementSystem.Admin.AddPublisher" %>
      ...
      <div class="row">
          <div class="col-lg-6 px-lg-4">
              <div class="form-group mb-4">
                  ...
                  <asp:TextBox ID="txtpublisherId" required="true" CssClass="form-control border-4 form-control-lg text-base" placeholder="publisher ID" runat="server"></asp:TextBox>
              </div>
          </div>
          ...
          <div class="col-lg-6 px-lg-4">
              <div class="form-group mb-4">
                  ...
                  <asp:TextBox ID="txtpublisherName" required="true" CssClass="form-control border-4 form-control-lg text-base" placeholder="Publisher Name" runat="server"></asp:TextBox>
              </div>
          </div>
